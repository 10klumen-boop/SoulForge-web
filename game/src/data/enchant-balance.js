...
const COLLECTIBLES = {
  ...
  zaken_blessed_earring: {
    ...
    uniqueEquipped: true,
    slot: "earring",
    desc: "Эпическая серьга. На персонаже: +10% крит в PvP и +0.25% к шансу заточки с +4. Можно точить свитками брони C. Работает лишь один экипированный.",
    bonuses: { pvpCritChance: 0.1, enchant: 0.0025, mdef: 4 },
  },
  baium_ring: {
    id: "baium_ring",
    name: "Кольцо Баюма",
