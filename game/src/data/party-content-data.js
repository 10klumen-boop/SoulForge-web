...
const WORLD_BOSSES = [
  {
    ...
    lore: {
      eyebrow: "Сказание",
      title: "Закен — проклятый капитан",
      lead: "О жадности, предательстве и силе, что пожирает человека.",
      cover: "assets/lore/zaken-lore.jpg?v=1",
      chapters: [
        {
          title: "Охотник за легендой",
          image: "assets/lore/zk-story-pirate.jpg?v=1",
          imageAlt: "Пират Закен",
          paragraphs: [
            "Капитан Закен был именем, от которого бледнели портовые стражи. Его боялись за клинок — и ещё больше за алчность, не знавшую дна. Обычная добыча ему наскучила. Его манила сказка о сокровищах титанов: о наследии гигантов, о силе, что не принадлежит людям и всё же зовёт их, как песня сирен.",
            "Чем дальше шла погоня, тем страннее становился капитан. Приказы звучали всё резче, взгляд — всё дальше. Экипаж ещё слушался. Но за его спиной уже шептались.",
          ],
        },
        {
          title: "Остров предательства",
          image: "assets/lore/zk-story-maroon.jpg?v=1",
          imageAlt: "Высадка на Остров Дьявола",
          paragraphs: [
            "Погоня привела к каменистому острову — тому, что позже назовут Островом Дьявола. Здесь терпение команды лопнуло, как снасть в шторм. Матросы заточили капитана на скалах, забрали сундуки и ушли в ночь, уверенные: голод и одиночество добьют его быстрее любой бури.",
            "Они ошиблись. На острове Закен нашёл то, за чем гнался всю жизнь. Сила древних гигантов ждала в камне и пыли — и она ответила тому, кто был достаточно жаден, чтобы взять её.",
          ],
        },
        {
          title: "Цена бессмертия",
          image: "assets/lore/zk-story-vampire.jpg?v=1",
          imageAlt: "Превращение Закена",
          paragraphs: [
            "Закен коснулся наследия гигантов и обрёл вечную жизнь. Но для человека эта сила оказалась неполной — словно меч без рукояти. Он утратил сущность пирата и стал вампиром: существом, которому нужна чужая кровь, чтобы помнить, что оно ещё существует.",
            "Тьма дала ему и иное: власть убивать предателей и запирать их души. Капитан, которого бросили умирать, вернулся. Уже не человеком.",
          ],
        },
        {
          title: "Остров мёртвых",
          image: "assets/locations/zaken-pirate-cave.jpg",
          imageAlt: "Остров Дьявола",
          paragraphs: [
            "Месть была полной и тихой, как отлив. Бывший экипаж и рабы пали от руки вампира и остались бродить по острову — мёртвые пираты и их капитаны, вечные свидетели собственной измены. Когда рабы дорыли подземный ход к твердыне, Закен перебил всех, кто держал кирку. Их души до сих пор живут в ловушках туннеля.",
            "Так Остров Дьявола стал царством проклятого капитана. Его сокровища всё ещё манят авантюристов, а сам он — вечный хозяин скал, доказательство одной истины Адена: сила гигантов не дарит бессмертие. Она забирает человека — и оставляет голод.",
          ],
        },
      ],
    },
  },
  {
    ...
    lore: {
      eyebrow: "Сказание",
      title: "Королева муравьёв",
      lead: "О мёртвой земле и матке, выросшей в её чреве.",
      cover: "assets/lore/queen-ant-lore.jpg?v=1",
      chapters: [
        {
          title: "Дьявол среди людей",
          image: "assets/lore/qa-story-wasteland.jpg?v=1",
          imageAlt: "Пустошь Глудио",
          paragraphs: [
            "Когда-то юг земель, что ныне зовут Глудио, дышал хлебом и водой. Пашни ложились волнами до горизонта, и ничто не предвещало, что однажды ветер принесёт сюда запах пепла.",
            "Из Башни Слоновой Кости вышел Белет — гений, слишком жадный до силы древних гигантов. Королевство и маги Башни ужаснулись его амбиции и обрушили на него запретную чёрную магию. Белета удалось лишь ранить и прогнать. А земля заплатила сполна.",
            "Поля почернели. Люди гибли без битвы. Власти нарекли Белета дьяволом среди людей — и в этом имени не было преувеличения. Он бежал. На месте живых пашен осталась Пустошь: молчаливая, треснувшая, словно шрам на теле Адена.",
          ],
        },
        {
          title: "Книга, убившая поля",
          image: "assets/lore/qa-story-nest.jpg?v=1",
          imageAlt: "Страницы в Муравейнике",
          paragraphs: [
            "Ещё до конца той войны открыли гримуар великого мага Кранвела — запретный том, хранивший силу, которой не следовало касаться смертным. Страницы вспыхнули. Магия высосала жизнь из почвы и породила тварей, каких прежде не видали даже в кошмарах.",
            "Певица заклинаний Диена, не выдержав содеянного, разорвала книгу в ярости и горе. Листы разлетелись по ветру, будто стая чёрных птиц. Годы спустя старец Касиан всё ещё бродит по краю Пустоши, надеясь вернуть земле дыхание. Но обрывки гримуара давно утащили в норы те, кто вырос на этой порче.",
          ],
        },
        {
          title: "Рождение улья",
          image: "assets/locations/queen-ant-nest.jpg",
          imageAlt: "Муравейник",
          paragraphs: [
            "На дыхании Белета и остатках запретной силы обычные насекомые раздулись до чудовищных размеров. Они вгрызлись в камень Пустоши и вырыли Муравейник — лабиринт, где нет солнца и где каждый шаг вторит чужому инстинкту.",
            "В сердце гнезда воссела Королева. Гигантская. Кровожадная. С клешнями, острыми как у богомола, и панцирем крепче стали. На ней лежала печать древних колдунов — но даже порча не смогла сломать закон улья. Большую часть жизни она стережёт яйца и личинок. А гнездо, год за годом, ползёт под корнями земли, расширяясь, как болезнь.",
          ],
        },
        {
          title: "Где проходит рой",
          image: "assets/lore/queen-ant-lore.jpg?v=1",
          imageAlt: "Королева муравьёв",
          paragraphs: [
            "Где проходит рой, не остаётся ни колоса, ни скота — только голая почва и сухой скрежет хитина. В тронной зале матки стоят царские стражи, а личинки залечивают её раны, будто сама тьма боится потерять хозяйку.",
            "Убить королеву — значит обезглавить улей. Колония впадает в агонию, и с тела её снимают кольцо — трофей, о котором шепчутся воины Адена. Так в памяти народов осталась не драконица Шилен и не безумный император, а матка мёртвой земли — дитя чужой войны и чужой жажды силы.",
          ],
        },
      ],
    },
