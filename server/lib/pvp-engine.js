...
function sanitizeSheet(raw) {
  ...
  const sheet = {
    ...
    genderId: String(raw.genderId || "male").slice(0, 16),
...
function publicMatchView(runtime, sheetA, sheetB, meta) {
  return {
    ...
    sheetA: {
      name: sheetA.name,
      level: sheetA.level,
      atkType: sheetA.atkType,
      raceId: sheetA.raceId,
      classId: sheetA.classId,
      genderId: sheetA.genderId,
      skills: sheetA.skills,
    },
    sheetB: {
      name: sheetB.name,
      level: sheetB.level,
      atkType: sheetB.atkType,
      raceId: sheetB.raceId,
      classId: sheetB.classId,
      genderId: sheetB.genderId,
      skills: sheetB.skills,
    },
    meta: meta || null,
  };
}
